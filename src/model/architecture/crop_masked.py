...
def create_cdl_model_masked(
    ...
    c7 = deconv2d_block_time_dist(c6, num_filters=num_filters, dropout=dropout, kernel_size=3, batchnorm=batchnorm, concat_layer=c4)
    c8 = deconv2d_block_time_dist(c7, num_filters=num_filters, dropout=dropout, kernel_size=3, batchnorm=batchnorm, concat_layer=c3)
    ...
    clstmForwards_2 = ConvLSTM2D(1, kernel_size=3, padding='same', activation="relu", return_sequences=False)(c10)
